...
router.put("/product", upload_middleware_1.upload.single("images"), upload_middleware_1.uploadMiddleware, upload_middleware_1.fileError, [
    (0, express_validator_1.query)("id")
        .not().isEmpty().withMessage("id tidak boleh kosong"),
...
], validation_middleware_1.default, jwt_middleware_1.default, product_controller_1.default.updateProduct);
router.post("/product", upload_middleware_1.upload.single("images"), upload_middleware_1.uploadMiddleware, upload_middleware_1.fileError, [
    (0, express_validator_1.body)("product_name")
        .not().isEmpty().withMessage("product_name tidak boleh kosong"),
    (0, express_validator_1.body)("price")
        .not().isEmpty().withMessage("price tidak boleh kosong"),
    ...
    (0, express_validator_1.body)("description")
        .not().isEmpty().withMessage("description tidak boleh kosong")
], validation_middleware_1.default, jwt_middleware_1.default, product_controller_1.default.createProduct);
